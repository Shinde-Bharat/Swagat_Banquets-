			...
			<div class="agile-contact-form">
				<div class="col-md-6 contact-form-left">
					<div class="w3layouts-contact-form-top">
						<h3>Get in touch</h3>
					<p>
					Welcome to our virtual doorstep! We value your thoughts, questions, and feedback. Whether you're a curious visitor, or a cherished customer, we're eager to connect with you.Reach out to us using the options below, <Br> let's start a conversation:
					</p></div>
